...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def Beat(self):
        ...
        # PHYSICS PARAMETERS
        c = 2.99792458 * 1E+8
        omega0 = 2 * pi * self.SpinBox_fc.value() * 1.0E+15
        delta = 2 * pi * self.SpinBox_dFreq.value() * 1.0E+15
        vart = self.SpinBox_tParam.value() * 1.E-15
        beta0 = self.SpinBox_k.value() * 1.0E6
        deltabeta = self.SpinBox_dBeta.value() * 1.E6
        varx = self.SpinBox_xParam.value() * 1.E-9
        Vg_I = delta / deltabeta
